(function() {
  tinymce.PluginManager.requireLangPack('insertexercise', 'en,de');
  ...
  tinymce.create('tinymce.plugins.InsertExercise', {
    InsertExercise: function(ed, url) {
      ...
      function showDialog() {       
        // Will return JSON if called via XHR.
        var exercises_url = '/'+location.pathname.split('/')[1]+'/exercises';
        // Will understand that it has received JSON and parse it as such.
        $.get(exercises_url).done(function(exercises) {
          ...
          win = editor.windowManager.open({
            ...
            body: [
              ...
              {type: 'container', classes: 'legend', html: '<p>'+ed.translate("If you haven't prepared an exercise yet, you may close this dialog and<br/>navigate to the exercise management screen (see the buttons in the<br/>upper right corner) and create one there. Once you open this dialog<br/>again, you will be able to select your exercise in the above menu.")+'</p>'},
          ...
          // so we let TinyMCE create unique IDs and use those.
      ...
      function insertExercise() {
        ...
        console.log("Inserting exercise #" + listbox.value() + " into content fragment HTML.");
